"""Conexión a la base de datos propia del Gateway (usuarios/credenciales).
Es la ÚNICA base de datos del sistema que conoce contraseñas; los
microservicios de dominio nunca las ven (ver ADR-002)."""
